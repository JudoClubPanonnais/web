export default function CGVPage() {
  const sections = [
    ...
    { title: '4. Dons en ligne', content: `4.1 Les dons effectués via le site sont libres, volontaires et sans contrepartie.\n\n4.2 Traitement des paiements par HelloAsso (sécurisé, TLS/SSL). Aucune donnée bancaire n'est stockée par le Club.\n\n4.3 Les dons sont définitifs et non remboursables, sauf erreur de montant signalée dans les 48h.` },
    ...
    { title: '7. Protection des données (RGPD)', content: `Les données personnelles sont utilisées exclusivement pour la gestion administrative du Club. Elles ne sont jamais cédées à des tiers. Droit d'accès, rectification et suppression : contact@judoclubpanonnais.com` },
