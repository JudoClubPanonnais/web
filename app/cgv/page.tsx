export default function CGVPage() {
  const sections = [
    ...
    { title: '5. Droit à l\'image', content: `Des photos et vidéos peuvent être réalisées lors des cours et événements à des fins de communication. Toute personne s'y opposant doit en informer le responsable du Club par écrit.` },
