export default function CGVPage() {
  const sections = [
    ...
    { title: '7. Protection des données (RGPD)', content: `Les données personnelles sont utilisées exclusivement pour la gestion administrative du Club. Elles ne sont jamais cédées à des tiers. Droit d'accès, rectification et suppression : contact@judoclubpanonnais.fr` },
